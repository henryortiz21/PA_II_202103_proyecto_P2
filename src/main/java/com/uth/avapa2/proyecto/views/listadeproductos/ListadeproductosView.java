package com.uth.avapa2.proyecto.views.listadeproductos;
...
@Route(value = "listaProductos", layout = MainLayout.class)
public class ListadeproductosView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public ListadeproductosView() {
        addClassName("listadeproductos-view");
        setSizeFull();
        grid.setHeight("100%");
