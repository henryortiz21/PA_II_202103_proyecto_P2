package com.uth.avapa2.proyecto.views.subasta;
...
@PageTitle("Subasta")
@Route(value = "subasta", layout = MainLayout.class)
@Tag("subasta-view")
@JsModule("./views/subasta/subasta-view.ts")
public class SubastaView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public SubastaView() {
        addClassNames("subasta-view", "flex", "flex-col", "h-full");
        sortBy.setItems("Popularity", "Newest first", "Oldest first","Probando");
