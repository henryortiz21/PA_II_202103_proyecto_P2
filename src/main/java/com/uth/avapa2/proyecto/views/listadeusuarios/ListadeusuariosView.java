...
@Route(value = "listaUsuarios", layout = MainLayout.class)
public class ListadeusuariosView extends Div implements AfterNavigationObserver {

    private Button bNuevoUsuario=new Button("Nuevo usuario");
    Grid<Person> grid = new Grid<>();

    public ListadeusuariosView() {
        addClassName("listadeusuarios-view");
        setSizeFull();
        grid.setHeight("100%");
    ...
    private Component createButtonLayout() {
        ...
        bNuevoUsuario.addThemeVariants(ButtonVariant.LUMO_PRIMARY);
        buttonLayout.add(bNuevoUsuario);
        return buttonLayout;
    }
