...
import stylesCss from 'themes/aduasoft/styles.css';
import '@vaadin/vaadin-lumo-styles/typography.js';
import '@vaadin/vaadin-lumo-styles/color.js';
import '@vaadin/vaadin-lumo-styles/spacing.js';
import '@vaadin/vaadin-lumo-styles/badge.js';
import vaadinButtonCss from 'themes/aduasoft/components/vaadin-button.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_aduasoft_componentCss']) {
    registerStyles(
      'vaadin-button',
      css`
    ...
    document['_vaadintheme_aduasoft_componentCss'] = true;
  }
